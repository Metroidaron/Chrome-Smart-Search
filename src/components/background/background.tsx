...
export default class Background extends React.Component<iProps, iState>{
    ...
    setImage(){
        let element = document.getElementById("backgroundLayer");
        (element != null) ? element.style.background = "url(https://images5.alphacoders.com/386/386084.jpg)" : null;
    }

    render(){
        return(<div id="backgroundLayer"></div>)
    }
